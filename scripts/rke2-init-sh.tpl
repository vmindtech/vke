#!/bin/bash
curl -LO -k https://github.com/vmindtech/vke-agent/releases/download/v1.2.0/vke-agent_v1.2.0_linux_amd64.tar.gz
systemctl stop ufw
systemctl disable ufw
tar -xvf vke-agent_v1.2.0_linux_amd64.tar.gz
chmod +x vke-agent
